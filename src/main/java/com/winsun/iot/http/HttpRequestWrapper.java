...
public class HttpRequestWrapper {
    ...
    private com.winsun.iot.http.HttpMethod method;
    ...
    public static HttpRequestWrapper parse(HttpRequest request) {
        ...
        if(Objects.equals(request.method(), HttpMethod.GET)){
            wrapper.method = com.winsun.iot.http.HttpMethod.Get;
        }else if(Objects.equals(request.method(), HttpMethod.POST)){
            wrapper.method = com.winsun.iot.http.HttpMethod.Post;
    ...
    public com.winsun.iot.http.HttpMethod getMethod() {
        return method;
    }
